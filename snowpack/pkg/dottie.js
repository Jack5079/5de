...
var dottie = createCommonjsModule(function (module, exports) {
(function(undefined$1) {
  ...
  Dottie.set = function(object, path, value, options) {
    ...
    for (var index = 0; index < length; index++) {
      ...
      if (!hasOwnProp.call(current, piece) || current[piece] === undefined$1 || (typeof current[piece] !== 'object' && options && options.force === true)) {
        current[piece] = {};
      }
