...
var RootElement = /** @class */ (function (_super) {
    __extends$3(RootElement, _super);
...
var LabelElement = /** @class */ (function (_super) {
    __extends$3(LabelElement, _super);
        ...
        if (displayElems.length > 0) {
            for (var _d = 0, _e = ['width', 'height', 'margin-top', 'margin-bottom', 'float']; _d < _e.length; _d++) {
                ...
                for (var index = 0; index < elem.length; index++) {
                    ...
                    this.addEntry(node_1, Rules.PropertyIgnoredDueToDisplay, localize$6('rule.propertyIgnoredDueToDisplayInline', "Property is ignored due to the display. With 'display: inline', the width, height, margin-top, margin-bottom, and float properties have no effect."));
                }
            }
        }
        ...
        if (displayElems.length > 0) {
            ...
            for (var index = 0; index < elem.length; index++) {
                ...
                if (value && !value.matches('none')) {
                    this.addEntry(node_2, Rules.PropertyIgnoredDueToDisplay, localize$6('rule.propertyIgnoredDueToDisplayInlineBlock', "inline-block is ignored due to the float. If 'float' has a value other than 'none', the box is floated and 'display' is treated as 'block'"));
                }
            }
        }
...
var SCSSScanner = /** @class */ (function (_super) {
    __extends$4(SCSSScanner, _super);
...
var SCSSCompletion = /** @class */ (function (_super) {
    __extends$6(SCSSCompletion, _super);
...
var LESSScanner = /** @class */ (function (_super) {
    __extends$7(LESSScanner, _super);
...
var LESSCompletion = /** @class */ (function (_super) {
    __extends$9(LESSCompletion, _super);
...
var SCSSNavigation = /** @class */ (function (_super) {
    __extends$a(SCSSNavigation, _super);
